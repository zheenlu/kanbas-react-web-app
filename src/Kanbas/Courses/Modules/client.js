...
// const MODULES_URL = "https://kanbas-node-server-app-jzgr.onrender.com/api/modules"; fwefwef
...
export const addModule = async (courseId, module) => {
	const response = await axios.post(
		...
		module
	); // the module is inside/related to the course, so we need to add the course id to the url
	return response.data;
};
